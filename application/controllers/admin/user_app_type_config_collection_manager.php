...
class user_app_type_config_collection_manager extends CrudIgnitionManager {
	...
	function custom_edit($id = 0) {
		...
		$data['type_options'] = $this -> crud_lib -> _process_data_source($this -> model -> crig_fields['type']['data_source']);		
