...
!function($) {
    ...
    Color.prototype = {
		...
		toARGB: function(h, s, b, a) {		
            var rgb = this.toRGB(h, s, b, a);
            return ColorUtils.rgbaToHex(rgb);
		},
    ...
    var Colorpicker = function(element, options) {
        ...
        if (format === 'rgba' || format === 'hsla' || format === 'argb') {
    ...
    Colorpicker.prototype = {
       ...
       destroy: function(){
        ...
        previewColor: function() {
            this.preview.backgroundColor = CPGlobal.translateFormats['rgba'].call(this);
