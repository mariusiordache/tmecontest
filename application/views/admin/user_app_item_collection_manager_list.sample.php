...
<?php include($crud_ignition_views_path . 'header.php'); ?><!-- END header -->
		...
		<table class="table table-bordered table-striped">
			<thead>
				...
				<th>id</th><th>type_id</th><th>key</th><th>path</th>					<td></td>
				</tr>
			</thead>
			<tbody>
				...
				<?php if($fields['id']['admin_header'] == 'on') { echo '<td>'.$item['id'].'</td>';  } ?><?php if($fields['type_id']['admin_header'] == 'on') { echo '<td>'.$item['type_id'].'</td>';  } ?><?php if($fields['key']['admin_header'] == 'on') { echo '<td>'.$item['key'].'</td>';  } ?><?php if($fields['path']['admin_header'] == 'on') { echo '<td>'.$item['path'].'</td>';  } ?>					<td>	
