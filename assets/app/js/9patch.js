...
function NinePatch(div) {
	...
	//console.log('9patch image source', this.bgImage.src);
	...
	//console.log('9patch image width', this.bgImage.width);
	//console.log(this.bgImage.src);
	...
	// area images
	if (false && this.horizontalPieces.length == 3 && this.verticalPieces.length == 3
...
NinePatch.prototype.draw = function() {
	...
	for (var i = 0, n = this.horizontalPieces.length; i < n; i++) {
		...
		if(i == 0 && this.horizontalPieces[i][0] == 's')
			paddingLeft = this.horizontalPieces[i][2];
			
		if(i == n-1 && this.horizontalPieces[i][0] == 's')
			paddingRight = this.horizontalPieces[i][2];
	...
	for (var i = 0, n = this.verticalPieces.length; i < n; i++) {
		...
		if(i == 0 && this.horizontalPieces[i][0] == 's')
			paddingTop = this.horizontalPieces[i][2];
			
		if(i == n-1 && this.horizontalPieces[i][0] == 's')
			paddingBottom = this.horizontalPieces[i][2];
	...
	tempIMG.onload = function(event){
		...
		_this.div.style.height = (parseFloat(_this.div.style.height) - paddingTop - paddingBottom) + 'px';
