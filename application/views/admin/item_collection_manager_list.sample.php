...
<?php include($crud_ignition_views_path . 'header.php'); ?><!-- END header -->
		...
		<div class="row-fluid">
			...
			<form method="get" class="form form-inline pull-right">
				...
				<select name="search_field" class="input-medium">
					...
					<option value="id" <?php if($search_field=='id') { echo 'selected="selected"'; } ?> >id</option><option value="slide_id" <?php if($search_field=='slide_id') { echo 'selected="selected"'; } ?> >slide_id</option><option value="type" <?php if($search_field=='type') { echo 'selected="selected"'; } ?> >type</option>				</select>
				<label>Sort</label>				
				<select name="sort_field" class="input-small">
					<option value="">Sort by ...</option>
					<option value="id" <?php if($sort_field=='id') { echo 'selected="selected"'; } ?> >id</option><option value="slide_id" <?php if($sort_field=='slide_id') { echo 'selected="selected"'; } ?> >slide_id</option><option value="type" <?php if($sort_field=='type') { echo 'selected="selected"'; } ?> >type</option>				</select>
		...
		<table class="table table-bordered table-striped">
			<thead>
				...
				<th>id</th><th>slide_id</th><th>type</th>					<td></td>
				</tr>
			</thead>
			<tbody>
				...
				<?php if($fields['id']['admin_header'] == 'on') { echo '<td>'.$item['id'].'</td>';  } ?><?php if($fields['slide_id']['admin_header'] == 'on') { echo '<td>'.$item['slide_id'].'</td>';  } ?><?php if($fields['type']['admin_header'] == 'on') { echo '<td>'.$item['type'].'</td>';  } ?>					<td>	
