...
!function($){
	...
	Typeahead.prototype = {
		...
		select: function () {
			var item = {}
			item[this.options.ajax.valueField] = this.$menu.find('.active').attr('data-value')
			item[this.options.ajax.displayField] = this.$menu.find('.active').attr('data-label')
		...
		render: function (items) {
			...
			items = $(items).map(function (i, item) {	
				if(typeof(item)=='object') {
					var label = item[that.ajax.displayField];
					var value = item[that.ajax.valueField];
				} else {
					var label = item;
					var value = item;
				}
				
				i = $(that.options.item).attr('data-value', value).attr('data-label', label);
