...
class slide_collection_manager extends CrudIgnitionManager {
	...
	function custom_edit($id = 0) {
		...
		$data['story_id_options'] = $this -> crud_lib -> _process_data_source($this -> model -> crig_fields['story_id']['data_source']);		
